...
@Composable
internal fun EditDeckScreen(
    state: EditDeckState,
    onIntent: (EditDeckIntent) -> Unit,
) {
    ...
    Column(
        ...
        Column(
            ...
            CaroTextField(
                value = state.name,
                onValueChange = { onIntent(EditDeckIntent.UpdateName(it)) },
            ...
            CaroTextArea(
                ...
                onValueChange = { onIntent(EditDeckIntent.UpdateDescription(it)) },
        ...
        CtaButton(
            ...
            onClick = { onIntent(EditDeckIntent.ClickConfirm) },
            modifier =
                Modifier
                    .fillMaxWidth()
