...
internal val CaroResponseValidator: ClientPlugin<HttpCallValidatorConfig> =
    createClientPlugin(
        name = "CaroResponseValidator",
        createConfiguration = ::HttpCallValidatorConfig,
    ) {
        this.pluginConfig.handleResponseExceptionWithRequest { cause, _ ->
